package com.datayes.schedule.job;

import com.datayes.mom.common.models.ResponseData;
import com.datayes.schedule.config.SpringContextUtil;
import com.datayes.schedule.util.DataMapUtil;
...
@Slf4j
public class CommonJobExecution implements Job {
